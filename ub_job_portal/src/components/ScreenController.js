...
import "./utility/css/ScreenController.css";
import ViewProfile from "./ViewProfile"; // Import the ViewProfile component

const ScreenController = ({ onLogout, clearUserType }) => {
    ...
    useEffect(() => {
        ...
        const viewProfileFromStorage =
            localStorage.getItem("viewProfileVisible");
    ...
    return (
        <div className="job-search-container">
            ...
            <Header
                ...
                onLogout={handleLogout}
            />
            {userType === "student" && <StudentContent />}
